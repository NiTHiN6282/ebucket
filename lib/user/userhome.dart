        ...
        child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    _cards('Monitors', Icons.computer, Colors.black87,
                        Colors.red, 1),
                    _cards('Oven', Icons.all_inbox, Colors.black87,
                        Colors.orange, 2),
                  ],
                ),
              ),
              Padding(
                ...
                child: Row(
                  children: [
                    _cards('CPU', Icons.account_box, Colors.black87, Colors.red,
                        3),
                    _cards('Fridge', Icons.outbox, Colors.black87,
                        Colors.orange, 4),
                  ],
                ),
              ),
              Padding(
                ...
                child: Row(
                  children: [
                    _cards('Mobile', Icons.account_box, Colors.black87,
                        Colors.red, 5),
                    _cards('Cooler', Icons.outbox, Colors.black87,
                        Colors.orange, 6),
                  ],
                ),
              ),
