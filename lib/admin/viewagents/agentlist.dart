      ...
      body: SafeArea(
        child: Padding(
          ...
          child: StreamBuilder<QuerySnapshot>(
            stream: FirebaseFirestore.instance.collection('user').where('usertype',isEqualTo: 'Collecting Agent').snapshots(),
                    ...
                    return Padding(
                      ...
                      child: Container(
                        decoration: BoxDecoration(
                          // color: Colors.red,
                          color: snapshot.data!.docs[index]['status']==1 ? Colors.green : Colors.red,
