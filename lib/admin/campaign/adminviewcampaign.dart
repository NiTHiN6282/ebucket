      ...
      body: SafeArea(
        child: Padding(
          ...
          child: StreamBuilder<QuerySnapshot>(
              stream: FirebaseFirestore.instance.collection('campaign').where('status',isEqualTo: 1).snapshots(),
                        ...
                        child: Center(
                          child: ListTile(
                            ...
                            trailing: IconButton(
                                ...
                                onPressed: () {
                                  FirebaseFirestore.instance.collection('campaign').doc(snapshot.data!.docs[index]['cid']).delete().then((value) {
                            ...
                            onTap: () {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => AdminCampaignDetails(
